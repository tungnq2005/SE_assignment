...
import { HiOutlineSearch, HiDownload, HiOutlineEye, HiX, HiCheck } from 'react-icons/hi';

// Mock Data - Danh sách tài liệu (Giữ nguyên như cũ)
...
export default function StudentLibraryPage() {
  ...
  const [viewMode, setViewMode] = useState<'none' | 'view'>('none');
  ...
  return (
    <div className="p-6 space-y-6">
      ...
      <div className="bg-white rounded-xl shadow-sm border p-6">
        <h1 className="text-3xl font-bold text-blue-900 mb-4">Thư viện tài liệu (Student)</h1>
        ...
        {filteredDocs.map((doc) => (
          ...
          >
            ...
            <div className="p-4 space-y-3">
              ...
              {/* Các nút hành động (ĐÃ BỎ NÚT GẮN) */}
